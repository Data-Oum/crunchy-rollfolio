  ...
  return (
    ...
    >
      ...
      <div className="relative border border-primary/30 rounded-lg px-4 py-3 text-center bg-background/40 backdrop-blur-sm">
        <div className="text-2xl sm:text-3xl font-black text-gradient-crunchy font-mono leading-none">
          {value}
        </div>
      ...
      >
        ...
        >
          <img
            ...
            style={{ filter: "saturate(1.4) hue-rotate(-10deg)" }}
          />
        </motion.div>
      ...
      >
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          <div className="flex-1 text-center lg:text-left">
            ...
            <div
              ref={lastNameRef}
              className="flex items-baseline gap-3 justify-center lg:justify-start mb-6 opacity-0"
            >
          ...
          <div ref={avatarRef} className="flex-shrink-0 relative opacity-0">
            ...
            >
              ...
              <motion.div
                ...
                className="w-48 h-48 sm:w-64 sm:h-64 lg:w-80 lg:h-80 rounded-full overflow-hidden relative"
                style={{
                  boxShadow:
