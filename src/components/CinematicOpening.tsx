...
/**
 * Cinematic letterbox bars that slide open on page load,
 * revealing the hero beneath — like an anime episode cold open.
 */
        ...
        >
          ...
          >
            <div className="text-center">
              ...
              >
                AMIT<span className="text-primary">FOLIO</span>
              </motion.h1>
              <motion.div
                initial={{ scaleX: 0 }}
                animate={{ scaleX: 1 }}
          ...
          {/* Bottom bar */}
          <motion.div
            className="w-full bg-background mt-auto"
            initial={{ height: "50vh" }}
            animate={{ height: "0vh" }}
            transition={{ duration: 1.6, delay: 1.2, ease: [0.76, 0, 0.24, 1] }}
          />
