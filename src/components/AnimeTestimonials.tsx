...
function TestimonialCard({ t }: { t: typeof PROFILE.testimonials[number] }) {
  return (
    <motion.div
    ...
    >
      ...
      <div className="p-6 sm:p-8 relative">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <motion.a href={t.li} target="_blank" rel="noopener noreferrer" whileHover={{ scale: 1.1 }}
...
export const AnimeTestimonials = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      if (cards?.length) {
        gsap.fromTo(cards, { y: 80, opacity: 0, scale: 0.85, rotateY: -5 }, {
          y: 0, opacity: 1, scale: 1, rotateY: 0, stagger: 0.15, duration: 1, ease: "power3.out",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div ref={headingRef} className="mb-20 text-center">
          ...
          <h2 className="reveal-el text-5xl sm:text-7xl font-black leading-none"
            ...
            <span className="text-gradient-crunchy">SAY</span>
          </h2>
