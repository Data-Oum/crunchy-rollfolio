      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div ref={headingRef} className="mb-20 text-center">
          ...
          <h2 className="reveal-el text-5xl sm:text-7xl font-black leading-none"
            ...
            <span className="text-gradient-gold">FIGHT</span>
          </h2>
        ...
        >
          ...
          <motion.a
            ...
            style={{
              background: "linear-gradient(135deg, hsl(43 65% 55% / 0.15), hsl(43 80% 60% / 0.1))",
              border: "1px solid hsl(43 65% 55% / 0.3)",
              boxShadow: "0 0 30px hsl(43 65% 55% / 0.1)",
            }}>
