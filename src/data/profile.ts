...
export const PROFILE = {
  ...
  story: [
    { yr: "2017", title: "起源 The Origin", color: "#C9A84C", icon: "◈", desc: "PHP developer. 13 government projects secured. GST portals from zero." },
    { yr: "2019", title: "修行 MCA & Upskill", color: "#F5C842", icon: "◉", desc: "8.61 CGPA. React, React Native, Web3 foundations." },
    { yr: "2021", title: "闘争 Web3 Era", color: "#DAA520", icon: "◆", desc: "NonceBlox. Solidity, DeFi, NFTs. 13+ apps in 3 years." },
    { yr: "2023", title: "覚醒 Lead Role", color: "#B8860B", icon: "●", desc: "50K+ users. MusicX, Housezy, Vulcan. C++ Native Modules." },
    { yr: "2025", title: "進化 AI + Health", color: "#C9A84C", icon: "◈", desc: "Health tech engine from scratch. RAG pipelines. VP-level ops." },
    { yr: "Now", title: "無限 Open", color: "#F5C842", icon: "→", desc: "VP Eng · CTO · Principal Architect. Mission over title." },
  ],
  ...
  services: [
    {
      ...
      sub: "Turn a concept into a roadmap", color: "#C9A84C",
    ...
    },
    {
      ...
      sub: "Architecture · Strategy · Reviews", color: "#F5C842",
    ...
    },
    {
      ...
      sub: "From zero to production", color: "#DAA520",
